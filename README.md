...
1. The herbal liquid sample is introduced to the sensor array.
2. Sensors measure various chemical and physical parameters.
3. ESP32 collects sensor readings.
4. Data is transmitted for processing and analysis.
5. Machine learning algorithms identify patterns in the collected data.
6. The system classifies and identifies the corresponding Dravya.
